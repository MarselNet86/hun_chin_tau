...
2. Добавьте жанры, студии, озвучки
3. Создайте аниме с описанием, постером и обложкой
4. Добавьте сезоны и эпизоды
5. Для каждого эпизода укажите источник видео (файл или URL)
